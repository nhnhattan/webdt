...
<br>
    ...
    <div class="content">
    	<div class="content_top">
	      ...
	      <div class="section group">
	      	<?php 
	      	$product_secondnormal = $product->getproduct_secondnormal();
	      	if($product_secondnormal){
	      		while ($result = $product_secondnormal->fetch_assoc()) {
 ...
 <div class="container" style="margin-left:964px;">
  ...
  <ul class="pagination">
    <li class="page-item"><a class="page-link" href="products1.php">Trang trước</a></li>

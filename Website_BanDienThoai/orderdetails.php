 ...
 <div class="main">
    <div class="content">
    	<div class="cartoption">		
			<div class="cartpage">
			    	<h3 style="color: #0f9ed8;font-family: Calibri;"><img src="images/bill.png" style="margin-top: -10px; "><strong> CHI TIẾT ĐƠN ĐẶT HÀNG</strong></h3>
					...
					<div class="shopping">
						...
						<div class="shopright">
							<!-- <a class="btn btn-black --hover rounded-0" style="margin-left: 150px;" href="payment.php">Thanh toán</a> -->
